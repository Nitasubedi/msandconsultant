                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('public/'.$article->image)}}" alt="" height="60px"
                                                width="60px" style="object-fit: contain"></td>
                                        <td>{{strip_tags(Str::limit($article['description'], '22')) }}</td>
                                        <td>
                                            @if ($article['is_active']=='1')
                                            <a href="{{route('article.inactive',$article->id)}}"><button
                                                    class="btn btn-success btn-sm">Active</button></a>
                                            @else
                                            <a href="{{route('article.active',$article->id)}}"><button
