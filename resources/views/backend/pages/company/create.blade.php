      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Create Company</h4>
                  <form action="{{route('company.store')}}" method="POST" id="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" name="pan_vat_no" class="form-control" id="tb-fname" placeholder="Enter Name here" required/>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" name="location_embed_link" class="form-control" id="tb-address" placeholder="Enter Here" required/>
