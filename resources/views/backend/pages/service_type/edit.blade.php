            ...
            <div class="d-flex align-items-center">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('service_type.index')}}"> Service Type</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Update Service Type</h4>
                  <form action="{{route('service_type.update', $serviceType->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <input type="text" name="name" class="form-control" value="{{$serviceType->name}}" id="tb-fname" placeholder="Enter Name here" required/>
