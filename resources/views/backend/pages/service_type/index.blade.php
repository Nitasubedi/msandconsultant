    ...
    <div class="page-breadcrumb">
        <div class="row">
            ...
            <div class="col-md-7 justify-content-end align-self-center d-md-flex">
                ...
                <a href="{{route('service_type.create')}}">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0">Service Types</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('service_type.inactive',$serviceType->id)}}"><button
                                                    class="btn btn-success btn-sm">Active</button></a>
                                            @else
                                            <a href="{{route('service_type.active',$serviceType->id)}}"><button
                                                    class="btn btn-danger btn-sm">Inactive</button></a>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="d-flex" style="gap: 3px;">
                                                <a href="{{route('service_type.edit',$serviceType->id)}}">
