      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Update FAQ</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <input type="text" name="question" value="{{$faq->question}}" class="form-control" id="tb-fname" placeholder="Enter Title here" required/>
                          <label for="tb-fname">Question?</label>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <textarea name="answer" id="textarea" hidden required>{{$faq->answer}} </textarea>
                        <div class="mb-3">
