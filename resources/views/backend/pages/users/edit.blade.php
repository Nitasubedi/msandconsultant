                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('users.update',$user->id)}}" method="POST" id="form"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="name" class="form-control" id="tb-fname"
                                            value="{{$user->name}}" placeholder="Enter Name here" required />
                                        <label for="tb-fname">Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="address" class="form-control" id="tb-address"
                                            value="{{$user->address}}" placeholder="Enter Address Here" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" name="dob" class="form-control" id="tb-phone_no"
                                            value="{{$user->dob}}" placeholder="Enter Here" required />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <p><img src="{{asset('public/'.$user->image)}}" alt="{{$user->name}}"
                                                id="output" width="100" /></p>
                                    </div>
                                </div>
                                <div class="col-12">
