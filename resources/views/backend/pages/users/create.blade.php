                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('users.store')}}" method="POST" id="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="name" class="form-control" value="{{old('name')}}"
                                            id="tb-fname" placeholder="Enter Name here" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="address" class="form-control"
                                            value="{{old('address')}}" id="tb-address" placeholder="Enter Address Here"
                                            required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" name="email" class="form-control" value="{{old('email')}}"
                                            id="tb-email" placeholder="name@example.com" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="password" name="password" class="form-control" id="tb-mobile_no"
                                            placeholder="Enter mobile_no Here" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="date" name="dob" value="{{old('dob')}}" class="form-control"
                                            id="tb-phone_no" placeholder="Enter Here" required />
