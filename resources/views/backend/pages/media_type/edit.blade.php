      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Update Media Type</h4>
                  <form action="{{route('media_type.update', $mediaType->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-floating mb-3">
                          <input type="text" name="name" class="form-control" value="{{$mediaType->name}}" id="tb-fname" placeholder="Enter Name here"/>
