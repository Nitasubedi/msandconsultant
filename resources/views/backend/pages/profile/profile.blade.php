        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="mt-4">
                            <img src="{{asset('public/'.Auth::user()->image)}}" class="rounded-circle" width="150" />
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-setting-tab" data-bs-toggle="pill"
                        ...
                        <div class="tab-pane fade show active" id="previous-month" role="tabpanel"
                            ...
                            <div class="card-body">
                                <form action="{{route('profile.update',Auth::user()->id)}}"
                                    class="form-horizontal form-material" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" name="email" placeholder="john@admin.com"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="{{asset('public/'.Auth::user()->image)}}" class="rounded-circle"
                                            id="output" width="150" />
                                    </div>
                                    <div class="mb-3">
                                        <div class="col-sm-12">
