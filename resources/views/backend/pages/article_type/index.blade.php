    ...
    <div class="page-breadcrumb">
        <div class="row">
            ...
            <div class="col-md-7 justify-content-end align-self-center d-md-flex">
                ...
                <a href="{{route('article_type.create')}}">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0">Article Types</h4>
                    </div>
                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($articleType['is_active']=='1')
                                            <a href="{{route('article_type.inactive',$articleType->id)}}"><button
                                                    class="btn btn-success btn-sm">Active</button></a>
                                            @else
                                            <a href="{{route('article_type.active',$articleType->id)}}"><button
                                                    class="btn btn-danger btn-sm">Inactive</button></a>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="d-flex" style="gap: 3px;">
                                                <a href="{{route('article_type.edit',$articleType->id)}}">
                                                    <button class="btn btn-primary btn-sm">
                                                        <i data-feather="edit" class="feather-sm"></i> Edit
                                                    </button>
                                                </a>
                                                <form action="{{route('article_type.destroy',$articleType->id)}}"
