                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('public/'.$testimonial->customer_img)}}" alt=""
                                                height="60px" width="60px" style="object-fit: contain"></td>
                                        <td>{{Str::limit($testimonial['message'], '22') }}</td>
                                        <td>
                                            @if ($testimonial['is_active']=='1')
                                            <a href="{{route('testimonial.inactive',$testimonial->id)}}"><button
                                                    class="btn btn-success btn-sm">Active</button></a>
                                            @else
                                            <a href="{{route('testimonial.active',$testimonial->id)}}"><button
