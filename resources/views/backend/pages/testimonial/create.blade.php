      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Create Testimonial</h4>
                  <form action="{{route('testimonial.store')}}" method="POST" id="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" name="customer_name" class="form-control" id="tb-fname" placeholder="Enter Title here" required/>
                      ...
                      <div class="col-md-12">
                        <textarea name="message" id="textarea" hidden></textarea>
                        <div class="mb-3">
