      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-3 pb-3 border-bottom">Update Media</h4>
                  <form action="{{route('media.update',$medium->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                              <select name="media_type_id" class="form-control" required>
                                ...
                                <option value="{{$mediaType->id}}"{{$mediaType->id == $medium->media_type_id ? 'selected': ''}}>{{$mediaType->name}}</option>
                                @endforeach
                              </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="text" name="title" value="{{$medium->title}}" class="form-control" id="tb-fname" placeholder="Enter Title here" required/>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <select name="has_time_limit" class="form-control" id="timeLimit">
                            <option value="0" {{$medium->has_time_limit == 0 ? 'selected': ''}}>No</option>
                            <option value="1" {{$medium->has_time_limit == 1 ? 'selected': ''}}>Yes</option>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating mb-3">
                          <input type="date" name="expires_on"  value="{{$medium->expires_on}}" class="form-control" id="expires" readonly/>
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <p><img src="{{asset('public/'.$medium->image)}}" id="output" width="100" /></p>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <textarea name="description" id="textarea" hidden> {{$medium->description}}</textarea>
                        <div class="mb-3">
