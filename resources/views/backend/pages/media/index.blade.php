                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('public/'.$media->image)}}" alt="" height="60px"
                                                width="60px" style="object-fit: contain"></td>
                                        <td>{{Str::limit($media['description'], '22') }}</td>
                                        <td>
                                            @if ($media['is_active']=='1')
                                            <a href="{{route('media.inactive',$media->id)}}"><button
                                                    class="btn btn-success btn-sm">Active</button></a>
                                            @else
                                            <a href="{{route('media.active',$media->id)}}"><button
